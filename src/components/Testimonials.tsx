...
//         <h2 className="text-3xl sm:text-4xl lg:text-6xl text-center mb-12 font-medium text-[#3D3D3D]">
//           What They Say About Us
//         </h2>
...
//             <div
//               key={idx}
//               className="bg-[#052557] p-6 rounded-xl shadow-md flex flex-col items-center text-center"
//             >
//               <Image
...
//                 {review.author_name}
//               </h3>
//               <p className="text-[#F7F6F2] mt-2">{review.text}</p>
...
//                     key={i}
//                     className={`w-5 h-5 ${
//                       i < review.rating ? "text-[#F8CA0A]" : "text-gray-400"
//                     }`}
//                     fill="currentColor"
//                     viewBox="0 0 20 20"
//                   >
