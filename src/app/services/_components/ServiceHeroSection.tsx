...
export default function ServiceHeroSection() {
  return (
    <section className="relative min-h-[70vh] sm:min-h-[75vh] md:min-h-[80vh] lg:min-h-[88vh] xl:min-h-[90vh] 2xl:min-h-[92vh] 3xl:min-h-[94vh] bg-gray-900 overflow-hidden flex items-center">
      ...
      <div className="relative z-20 w-full max-w-[125rem]  mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-18 2xl:px-24 3xl:px-32 py-12 sm:py-16 md:py-20 lg:py-24 xl:py-28 2xl:py-32 3xl:py-40">
        <div className="max-w-sm sm:max-w-lg md:max-w-xl lg:max-w-2xl xl:max-w-2xl 2xl:max-w-3xl 3xl:max-w-5xl space-y-4 sm:space-y-5 md:space-y-6 lg:space-y-8 xl:space-y-10 2xl:space-y-12 3xl:space-y-14">
          {/* Updated Headline */}
          <h1 className="text-white text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl 3xl:text-7xl font-medium leading-tight drop-shadow-2xl ">
            Where expertise meets efficiency —{" "}
            <br className="hidden sm:block" />
            premium security without compromise.
          </h1>
