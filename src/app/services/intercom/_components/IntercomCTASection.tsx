  ...
  return (
    <section className="bg-gradient-to-r from-blue-600 to-indigo-700 py-16 sm:py-20 lg:py-24 xl:py-28 2xl:py-32 3xl:py-40">
      <div className="max-w-7xl 2xl:max-w-[90rem] 3xl:max-w-[120rem] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-16 3xl:px-24 text-center">
        ...
        <p className="text-blue-100 text-base sm:text-lg lg:text-xl xl:text-xl 2xl:text-2xl 3xl:text-3xl leading-relaxed mb-10  mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <button
           ...
           2xl:px-10 2x:py-5 3x:px-12 3xl:py-6  rounded-lg text-sm sm:text-base lg:text-lg font-medium hover:bg-gray-100 transition-colors"
          >
            Schedule Consultation
          </button>
          <button className="border-2 border-white text-white px-6 sm:px-8 py-3 sm:py-4 2xl:px-10 2x:py-5 3x:px-12 3xl:py-6 rounded-lg text-sm sm:text-base lg:text-lg font-medium hover:bg-white hover:text-blue-600 transition-colors">
            Call (555) 123-4567
          </button>
        </div>
      </div>
