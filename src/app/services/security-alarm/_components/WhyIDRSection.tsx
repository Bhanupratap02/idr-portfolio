    ...
    <section className="bg-[#F8F8F8] py-20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center">
          <Button className="bg-[#0056B3] hover:bg-[#0056B3]/90 text-white px-8 py-6 text-base flex items-center gap-3 mx-auto">
