...
import CTABg from "@/assets/services/e-rate-program/cta.png";
export default function CallToActionSection() {
  return (
    <section className="w-full  relative bg-cover bg-center overflow-hidden">
      {/* Background Image Container */}
      <div className="absolute inset-0 w-full h-full">
        <Image
          src={CTABg}
          alt="Digital education technology background"
          fill
      ...
      <div className="relative max-w-7xl 2xl:max-w-[95rem] 3xl:max-w-[120rem] mx-auto px-4 sm:px-6 lg:px-12 xl:px-16 2xl:px-24 3xl:px-32  h-[400px] sm:h-[450px] md:h-[500px] lg:h-[520px] xl:h-[548px] 2xl:h-[600px] 3xl:h-[680px] flex flex-col items-center justify-center text-center">
