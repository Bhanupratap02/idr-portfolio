      ...
      <div className="max-w-7xl mx-auto px-8 lg:px-28">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-[#626262] leading-[155.556%] max-w-4xl mx-auto">
            Whether you're launching a new build or modernizing an older setup,
            we'll make sure your cameras work — and keep working.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-[#F9FAFB] rounded-xl p-6">
            ...
            <h3 className="text-xl font-medium text-[#2E2E2E] mb-3">
              Full Design + Install + Support
            </h3>
            <p className="text-base text-[#626262] leading-[150%]">
              Complete service from day one through ongoing maintenance
            </p>
          </div>
          ...
          <div className="bg-[#F9FAFB] rounded-xl p-6">
            ...
            <p className="text-base text-[#626262] leading-[150%]">
              Every job gets a dedicated manager to see it through completion
            </p>
          </div>
          ...
          <div className="bg-[#F9FAFB] rounded-xl p-6">
            ...
            <p className="text-base text-[#626262] leading-[150%]">
              Our techs, not subcontractors, handle your installation
            </p>
          </div>
          ...
          <div className="bg-[#F9FAFB] rounded-xl p-6">
            ...
            <p className="text-base text-[#626262] leading-[150%]">
              Direct access to our support team for any needs
            </p>
          </div>
          ...
          <div className="bg-[#F9FAFB] rounded-xl p-6">
            ...
            <p className="text-base text-[#626262] leading-[150%]">
              Long-term support contracts available for peace of mind
            </p>
          </div>
          ...
          <div className="bg-[#F9FAFB] rounded-xl p-6">
            ...
            <p className="text-base text-[#626262] leading-[150%]">
              Easy service tracking and complete documentation
            </p>
          </div>
        </div>
      </div>
