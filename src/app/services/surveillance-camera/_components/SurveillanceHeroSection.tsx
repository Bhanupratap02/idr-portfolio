...
export default function SurveillanceHeroSection() {
  return (
    <section className="w-full min-h-[80vh] sm:min-h-[85vh] lg:min-h-[90vh] xl:min-h-[85vh] 2xl:min-h-[90vh] 3xl:min-h-[88vh] bg-gradient-to-r from-[#1E3A8A] via-[#1E40AF] to-[#1D4ED8] relative overflow-hidden flex  items-center">
      ...
      <div className="relative  max-w-7xl 2xl:max-w-[90rem] 3xl:max-w-[120rem] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-16 3xl:px-24  h-full">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-4  2xl:gap-20 items-center h-full pb-8 sm:pb-12">
          ...
          <div className="space-y-6 sm:space-y-7 lg:space-y-8 xl:space-y-10 2xl:space-y-12 flex flex-col justify-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-4xl xl:text-5xl 2xl:text-6xl 3xl:text-7xl font-semibold text-white leading-tight sm:leading-tight lg:leading-snug xl:leading-relaxed">
              Surveillance
              <br />
              Camera Systems
            </h1>
            <p className="text-base sm:text-lg lg:text-xl xl:text-xl 2xl:text-2xl 3xl:text-3xl 3xl:leading-relaxed max-w-2xl  text-[#DBEAFE] ">
          ...
          <div className="relative flex justify-center lg:justify-end items-center">
            ...
            <div className=" relative w-full max-w-[400px] sm:max-w-[500px] lg:max-w-[550px] xl:max-w-[550px] 2xl:max-w-[700px] 3xl:max-w-[750px]  h-[220px] sm:h-[300px] md:h-[350px] lg:h-[384px] xl:h-[450px] 2xl:h-[500px] 3xl:h-[590px]  rounded-xl  overflow-hidden">
              <Image
                src={hero}
