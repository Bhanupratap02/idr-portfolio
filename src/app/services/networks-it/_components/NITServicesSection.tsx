          ...
          <div className="max-w-6xl w-full">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="w-full">
                <div className="bg-blue-50 rounded-2xl p-8 shadow-lg h-full">
                  <img
                    src="https://api.builder.io/api/v1/image/assets/TEMP/2192bb64ca3f39a6509cfdc3ad733eb5bc532f34?width=832"
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    Comprehensive network planning with heat mapping, capacity
                    planning, and redundancy strategies.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    Professional installation of Cat6/6A cabling, fiber optics,
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    Enterprise Wi-Fi deployment with seamless roaming, guest
                    networks, and high-density coverage.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    On-premises and hybrid cloud solutions for data storage,
                    backup, and application hosting.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    Redundant power solutions with battery backup and power
                    conditioning for critical infrastructure.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    Firewall implementation, VPN solutions, and network
                    segmentation to protect your data.
                  </p>
                </div>
              </div>
            </div>
