    ...
    <section className="py-16 sm:py-20 lg:py-24 bg-gray-50">
      ...
      <div className="max-w-[85rem] 2xl:max-w-[90rem] 3xl:max-w-[120rem] mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 2xl:gap-12 3xl:gap-16 items-center">
          ...
          <div className="relative w-full aspect-[4/3] lg:aspect-[16/10] 2xl:aspect-[16/9] bg-white rounded-2xl">
            <Image
              src={portal}
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 xl:p-10 shadow-lg flex flex-col justify-between">
            ...
            <div className="mt-8">
              <Link
                href={"/contact"}
                className="bg-blue-600 text-white px-6 py-3 3xl:px-8 3xl:py-4 rounded-lg font-normal hover:bg-blue-700 transition-colors cursor-pointer"
              >
                Request Portal Demo
              </Link>
            </div>
