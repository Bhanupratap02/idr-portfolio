        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 text-center lg:text-left ">
            <h1 className="text-2xl sm:text-3xl md:text-4xl xl:text-5xl 3xl:text-6xl  font-medium leading-tight text-gray-800">
              Networks & IT <p className="inline lg:block">Infrastructure</p>
            </h1>
            ...
            <p className="text-sm sm:text-base md:text-lg lg:text-lg xl:text-xl 2xl:text-2xl 3xl:text-3xl text-gray-600 leading-relaxed 3xl:leading-loose max-w-full lg:max-w-2xl xl:max-w-3xl 2xl:max-w-4xl  mx-auto lg:mx-0">
              ...
              everything from  Wi-Fi to surveillance, access control,
              intercoms, and smart building systems.
            </p>
            <div className="flex flex-wrap justify-center lg:justify-start gap-4">
              <Link
                href={"/contact"}
                className="bg-blue-600 text-white px-6 2xl:px-8 py-3 2xl:py-4 rounded-lg font-medium text-sm sm:text-base lg:text-lg 2xl:text-xl hover:bg-blue-700 transition-colors cursor-pointer"
              >
                Get Network Assessment
              </Link>
              <Link
                href={"/portfolio"}
                className="border border-gray-300 text-gray-700 px-6 2xl:px-8 py-3 2xl:py-4 rounded-lg font-medium text-sm sm:text-base lg:text-lg 2xl:text-xl hover:bg-gray-50 transition-colors cursor-pointer"
              >
                View Our Work
              </Link>
            </div>
