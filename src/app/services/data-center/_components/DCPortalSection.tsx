          ...
          <div>
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start space-x-4">
                <div className="w-8 h-10 bg-blue-600 rounded-md flex items-center justify-center flex-shrink-0">
                  <svg
                    width="14"
                    height="16"
                    viewBox="0 0 14 16"
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-600">
                    Access all cable test results with pass/fail indicators and
                    certification data.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-600">
                    View and download rack elevations, cable paths, and network
                    diagrams.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-600">
                    Submit and track support requests with real-time status
                    updates.
                  </p>
                </div>
              </div>
            ...
            <button className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-md font-normal transition-colors inline-flex items-center space-x-3">
