...
export default function DCProcessSection() {
  ...
  return (
    <section className="py-16 sm:py-20 lg:py-24 bg-gray-100">
      <div className="max-w-7xl 2xl:max-w-[90rem] 3xl:max-w-[110rem] mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
        {/* Header */}
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl xl:text-5xl 2xl:text-6xl font-medium text-gray-800 mb-4">
            The IDR Process
          </h2>
              ...
              >
                ...
                <div
                  className={` mt-14 md:mt-0 w-full md:w-1/2 ${
                    process.side === "left"
                      ? "md:text-right md:pr-16 md:mr-auto"
                      : "md:text-left md:pl-16 md:ml-auto"
                  } text-center md:text-inherit`}
                >
                  <h3 className="text-lg sm:text-xl md:text-2xl font-medium text-gray-800 mb-3">
                    {process.title}
                  </h3>
