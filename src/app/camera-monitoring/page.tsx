...
import cameraMonitoringHero from "@/assets/camera-monitoring-hero.jpg";
    ...
    <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-stretch">
      ...
      <div className="order-2 lg:order-1 flex flex-col justify-center text-center lg:text-left">
        ...
        <p className="text-base sm:text-lg lg:text-xl text-blue-100 mb-6 sm:mb-8 leading-relaxed">
          IDR&apos;s camera monitoring services deliver real-time visibility, AI-driven alerts,
          and live human response — ensuring every incident gets attention the moment it happens.
        </p>
      ...
      <div className="order-1 lg:order-2">
        <div className="relative rounded-2xl overflow-hidden shadow-2xl group h-full">
          <img
            src={cameraMonitoringHero.src}
            alt="Security Operations Center"
            className="w-full h-full object-cover object-center min-h-[300px] sm:min-h-[400px] lg:h-full"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-blue-900/40 to-transparent"></div>

          {/* Floating Stats */}
          <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-sm rounded-lg px-4 py-2 shadow-lg">
            <div className="text-xs font-semibold text-slate-600">Live Monitoring</div>
            <div className="text-2xl font-bold text-blue-600">24/7</div>
          </div>

          <div className="absolute bottom-4 left-4 bg-white/95 backdrop-blur-sm rounded-lg px-4 py-2 shadow-lg">
            <div className="text-xs font-semibold text-slate-600">Response Time</div>
          ...
          <div className="order-2 lg:order-1 space-y-4 sm:space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-start space-x-4 mb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-slate-900 mb-2">Human Verification</h3>
                  <p className="text-slate-600 leading-relaxed">
        ...
        <div className="mb-16 sm:mb-24 lg:mb-32">
          <div className="text-center mb-12 sm:mb-16">
            <div className="inline-block bg-blue-100 rounded-lg px-4 py-2 mb-6">
              <span className="text-blue-800 font-semibold text-sm uppercase tracking-wide">Comprehensive Coverage</span>
            </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            {[
              ...
              >
                <div className={`inline-flex items-center justify-center w-14 h-14 rounded-xl bg-${feature.color}-100 mb-6 group-hover:scale-110 transition-transform duration-300`}>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-10 sm:mb-12">
              <div className="inline-block bg-purple-100 rounded-lg px-4 py-2 mb-6">
                <span className="text-purple-800 font-semibold text-sm uppercase tracking-wide">Our Promise</span>
              </div>
            ...
            <div className="grid sm:grid-cols-3 gap-6 sm:gap-8 mb-10 sm:mb-12">
              {[
                ...
                <div key={idx} className="text-center group">
                  <div className={`inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-${pillar.color}-100 border-2 border-${pillar.color}-200 mb-4 group-hover:scale-110 transition-transform duration-300`}>
                    <pillar.icon className={`w-8 h-8 sm:w-10 sm:h-10 text-${pillar.color}-600`} />
                  </div>
                  <h3 className="text-xl sm:text-2xl font-bold text-slate-900">{pillar.title}</h3>
                </div>
              ))}
            </div>
