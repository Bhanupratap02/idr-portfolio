...
export default function Index() {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
<section className="w-full h-[800px] bg-gradient-to-r from-white to-blue-50 relative">
  <div className="container mx-auto px-6 h-full flex items-center justify-between">
    {/* Left Content */}
    <div className="max-w-[601px] flex flex-col gap-4">
      <h1 className="text-5xl font-semibold leading-[150%] text-rhombus-text-dark">
        Rhombus Systems: Smart Video Surveillance in the Cloud
      </h1>
      <p className="text-2xl leading-[150%] text-rhombus-text-medium">
        Certified by Rhombus. Designed, Installed, and Supported by IDR Technology Solutions.
      </p>
      <div className="flex gap-4 mt-8">
        <button className="bg-rhombus-dark-blue text-white bg-[#052557] px-6 py-4 rounded-md hover:opacity-90 transition-opacity">
          Get a Free Demo
        </button>
        <button className="border border-rhombus-dark-blue text-rhombus-dark-blue px-7 py-4 rounded-md hover:bg-gray-50 transition-colors">
          Design My System
        </button>
      </div>
    </div>
    ...
    <div>
      <img
        ...
        className="w-[590px] h-[484px] rounded-[22px] object-cover"
      />
    </div>
  </div>
</section>
      ...
      <section className="w-full py-16 bg-white">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-medium text-center text-rhombus-text-dark mb-16">
            Smarter, Simpler, and Fully Cloud-Native
          </h2>
          <div className="flex items-start gap-24">
            <div className="flex-1 max-w-[663px]">
              <p className="text-xl leading-[150%] text-rhombus-text-dark mb-8">
              ...
              <p className="text-xl leading-[150%] text-rhombus-text-dark mb-12">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-xl text-blue-600">No on-premises servers required</span>
                </div>
                <div className="flex items-center gap-4">
                  <CheckCircle className="w-6 h-6 text-blue-600 flex-shrink-0" />
                  <span className="text-xl text-blue-600">Accessible from any device, anywhere</span>
                </div>
                <div className="flex items-center gap-4">
                  <CheckCircle className="w-6 h-6 text-blue-600 flex-shrink-0" />
                  <span className="text-xl text-blue-600">Automatic updates and maintenance</span>
                </div>
              </div>
            </div>
            <div className="w-[451px] h-[451px] relative">
              <img 
                ...
                className="w-full h-full rounded-[19px] object-cover shadow-lg"
              />
              <div className="absolute top-3 left-[18px] bg-blue-600 rounded-full w-24 h-24 flex items-center justify-center">
                <div className="text-center">
                  <div className="text-white text-xs font-bold">100% Cloud</div>
                  <div className="text-white text-xs font-bold">Native</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-white rounded-lg p-8 shadow-md">
              ...
              <h3 className="text-xl font-medium text-rhombus-text-dark mb-4">True Cloud Platform</h3>
            ...
            <div className="bg-white rounded-lg p-8 shadow-md">
              ...
              <h3 className="text-xl font-medium text-rhombus-text-dark mb-4">Smart Detection</h3>
              <p className="text-gray-600 leading-6">
            ...
            {/* Encrypted Recording */}
            <div className="bg-white rounded-lg p-8 shadow-md">
              <div className="w-8 h-9 mb-6">
                <Shield className="w-full h-full text-blue-600" />
              </div>
              <h3 className="text-xl font-medium text-rhombus-text-dark mb-4">Encrypted Recording</h3>
              <p className="text-gray-600 leading-6">
            ...
            {/* Access Anywhere */}
            <div className="bg-white rounded-lg p-8 shadow-md">
              <div className="w-7 h-9 mb-6">
                <Smartphone className="w-full h-full text-blue-600" />
              </div>
              <h3 className="text-xl font-medium text-rhombus-text-dark mb-4">Access Anywhere</h3>
              <p className="text-gray-600 leading-6">
            ...
            <div className="bg-white rounded-lg p-8 shadow-md">
              ...
              <h3 className="text-xl font-medium text-rhombus-text-dark mb-4">AI-Powered Search</h3>
              <p className="text-gray-600 leading-6">
            ...
            <div className="bg-white rounded-lg p-8 shadow-md">
              ...
              <h3 className="text-xl font-medium text-rhombus-text-dark mb-4">Easy Integration</h3>
              <p className="text-gray-600 leading-6">
          ...
          <div className="text-center">
            <button className="bg-rhombus-dark-blue text-white px-6 py-3 rounded-md hover:opacity-90 transition-opacity">
          ...
          <div className="flex gap-12 items-start">
            <div className="flex-1">
              <img 
                ...
                className="w-full h-[489px] rounded-[22px] object-cover"
              />
            </div>
              ...
              <div className="bg-blue-50 rounded-lg p-8">
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-lg font-medium text-rhombus-text-dark mb-2">Certified Rhombus Partner</h4>
                      <p className="text-gray-600">Officially trained and endorsed by Rhombus Systems</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <Shield className="w-6 h-6 text-blue-600 flex-shrink-0 mt-1" />
                    <div>
                      <h4 className="text-lg font-medium text-rhombus-text-dark mb-2">Licensed + Insured</h4>
                      <p className="text-gray-600">NYS Alarm License and fully insured for your protection</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <Users className="w-5 h-6 text-blue-600 flex-shrink-0 mt-1" />
                    <div>
                      <h4 className="text-lg font-medium text-rhombus-text-dark mb-2">Multi-Site Experience</h4>
                      <p className="text-gray-600">Expertise with large-scale, multi-site rollouts</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <svg className="w-5 h-6 text-blue-600 flex-shrink-0 mt-1" viewBox="0 0 21 25" fill="currentColor">
                    ...
                    <div>
                      <h4 className="text-lg font-medium text-rhombus-text-dark mb-2">Alert Configuration Experts</h4>
                      <p className="text-gray-600">Custom alerting and notification setup</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <Link className="w-8 h-6 text-blue-600 flex-shrink-0 mt-1" />
                    <div>
                      <h4 className="text-lg font-medium text-rhombus-text-dark mb-2">Integration Specialists</h4>
                      <p className="text-gray-600">Connecting Rhombus to Kisi, intercoms, and more</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="relative rounded-lg overflow-hidden shadow-lg h-64">
              ...
              <div className="absolute bottom-0 left-0 p-6 text-white">
                ...
                <h3 className="text-xl font-bold mb-2">Charter Schools & Universities</h3>
                <p className="text-base">Secure campus monitoring with vape detection and access control integration.</p>
              </div>
            </div>
            ...
            <div className="relative rounded-lg overflow-hidden shadow-lg h-64">
              ...
              <div className="absolute bottom-0 left-0 p-6 text-white">
                ...
                <p className="text-base">Secure access points and monitor shared spaces with cloud-based efficiency.</p>
              </div>
            </div>
            ...
            <div className="relative rounded-lg overflow-hidden shadow-lg h-64">
              ...
              <div className="absolute bottom-0 left-0 p-6 text-white">
                ...
                <h3 className="text-xl font-bold mb-2">Condos & Multi-Tenant Housing</h3>
                <p className="text-base">Enhance resident safety with doorway monitoring and package detection.</p>
              </div>
            </div>
            ...
            <div className="relative rounded-lg overflow-hidden shadow-lg h-64">
              ...
              <div className="absolute bottom-0 left-0 p-6 text-white">
                ...
                <h3 className="text-xl font-bold mb-2">Gyms & Fitness Facilities</h3>
                <p className="text-base">Monitor 24/7 access and protect valuable equipment with smart alerts.</p>
              </div>
            </div>
            ...
            <div className="relative rounded-lg overflow-hidden shadow-lg h-64">
              ...
              <div className="absolute bottom-0 left-0 p-6 text-white">
                ...
                <h3 className="text-xl font-bold mb-2">Industrial Sites & Warehouses</h3>
                <p className="text-base">Secure large facilities and monitor valuable inventory with AI detection.</p>
              </div>
            </div>

            {/* Custom Solutions */}
            <div className="bg-blue-600 rounded-lg p-8 shadow-lg flex flex-col justify-center items-center text-center text-white h-64">
              <div className="w-9 h-12 mb-6">
              ...
              <h3 className="text-xl font-medium mb-4">Have a Unique Space?</h3>
              <p className="text-base mb-6">We design custom solutions for any environment.</p>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-16">
            ...
            <div className="flex gap-6">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-medium text-rhombus-text-dark mb-4">Rhombus + Kisi</h3>
                ...
                <div className="flex items-center gap-2 text-blue-600 text-sm">
                  <svg className="w-3 h-3.5" viewBox="0 0 13 15" fill="currentColor">
            ...
            <div className="flex gap-6">
              <div className="w-16 h-16 bg-blue-50 rounded-full flex items-center justify-center flex-shrink-0">
                <Users className="w-7 h-6 text-blue-600" />
              </div>
              <div className="flex-1">
                <h3 className="text-xl font-medium text-rhombus-text-dark mb-4">Rhombus + Access Control</h3>
                <p className="text-gray-600 mb-4 leading-6">
            ...
            <div className="flex gap-6">
              <div className="w-16 h-16 bg-blue-50 rounded-full flex items-center justify-center flex-shrink-0">
                <svg className="w-8 h-6 text-blue-600" viewBox="0 0 30 24" fill="currentColor">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-medium text-rhombus-text-dark mb-4">Rhombus + Vape Detection</h3>
                <p className="text-gray-600 mb-4 leading-6">
            ...
            <div className="flex gap-6">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-medium text-rhombus-text-dark mb-4">Rhombus + Annunciators</h3>
                <p className="text-gray-600 mb-4 leading-6">
          ...
          <div className="text-center">
            <img 
              ...
              className="w-full max-w-[1085px] h-auto rounded-[23px] mx-auto"
            />
          </div>
        </div>
      </section>
          ...
          <div className="flex gap-12 items-center">
            <div className="flex-1">
              <img 
                ...
                alt="Deployment Map" 
                className="w-full h-[600px] rounded-lg object-cover shadow-lg"
              />
            </div>
            <div className="w-[600px] bg-white rounded-lg p-8 shadow-md">
              <h3 className="text-2xl font-medium text-rhombus-text-dark mb-8">
                IDR supports Rhombus installs across:
              </h3>
              <div className="space-y-4 mb-8">
                <div className="flex items-center gap-4">
                  <MapPin className="w-4 h-5 text-blue-600 flex-shrink-0" />
                  <span className="text-lg text-rhombus-text-dark">New York City & Metropolitan Area</span>
                </div>
                <div className="flex items-center gap-4">
                  <MapPin className="w-4 h-5 text-blue-600 flex-shrink-0" />
                  <span className="text-lg text-rhombus-text-dark">North & Central New Jersey</span>
                </div>
                <div className="flex items-center gap-4">
                  <MapPin className="w-4 h-5 text-blue-600 flex-shrink-0" />
                  <span className="text-lg text-rhombus-text-dark">South Florida</span>
                </div>
                <div className="flex items-center gap-4">
                  <Globe className="w-5 h-5 text-blue-600 flex-shrink-0" />
                  <span className="text-lg text-rhombus-text-dark">Nationwide via remote support & partner network</span>
                </div>
              </div>
              <div className="bg-blue-50 rounded-lg p-4 flex items-center gap-3">
                <Headphones className="w-4 h-4 text-blue-600 flex-shrink-0" />
                <span className="text-base text-rhombus-text-dark">Remote support available for all locations</span>
              </div>
            </div>
          </div>
        </div>
