  ...
  return (
    <section className="bg-white py-12 sm:py-16 md:py-20 xl:py-24 2xl:py-28">
      <div className="max-w-7xl xl:max-w-[90rem] 2xl:max-w-[120rem] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20">
        ...
        {/* 🔹 Full-Width Kisi Kit Image Section */}
        <div className="w-full bg-gray-100 flex justify-center items-center pt-10 sm:pt-12 md:pt-16   mb-10 sm:mb-12 md:mb-16 rounded-2xl border border-gray-200">
          <div className="relative w-[80%] sm:w-[70%] md:w-[60%] lg:w-[50%] xl:w-[45%] 2xl:w-[40%] aspect-[3/2]">
            <Image
              src={kisiKitImg}
              alt="Kisi Kit"
              fill
              className="object-contain"
              sizes="(max-width: 768px) 90vw, (max-width: 1280px) 60vw, 40vw"
              priority
            />
          </div>
        </div>
