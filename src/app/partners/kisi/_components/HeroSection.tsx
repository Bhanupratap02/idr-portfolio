        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 xl:gap-16 2xl:gap-20 items-center">
          ...
          <div className="space-y-4 sm:space-y-6 lg:space-y-7 xl:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2">
              <button className="bg-[#052557] text-white px-6 sm:px-7 lg:px-8 py-3 sm:py-3.5 lg:py-4 text-sm sm:text-base lg:text-lg rounded-lg hover:bg-[#041b3f] transition-colors font-medium">
                Get a Quote
              </button>
