      ...
      <div className="max-w-7xl xl:max-w-[90rem] 2xl:max-w-[120rem] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 xl:gap-14 2xl:gap-16">
          {features.map((feature, index) => (
            ...
            >
              <div className="p-0">
                <div className="relative w-full h-36 sm:h-40 md:h-48 xl:h-56 2xl:h-64">
                  <Image
                ...
                <div className="p-4 sm:p-5 md:p-6 xl:p-7 2xl:p-9 flex flex-col min-h-[220px] sm:min-h-[240px] md:min-h-[260px] xl:min-h-[300px] 2xl:min-h-[320px]">
