    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 lg:gap-12 xl:gap-16 2xl:gap-20 items-center">
      ...
      <div className="flex flex-col gap-4 lg:gap-6 max-w-full lg:max-w-[569px] xl:max-w-[640px]">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-4 lg:mt-8">
          <Button className="bg-[#052557] hover:bg-[#041e44] text-white px-6 lg:px-7 xl:px-8 py-3 lg:py-4 h-auto lg:h-[54px] text-base lg:text-lg whitespace-nowrap">
            Schedule Demo
          </Button>
          <Button 
            variant="outline" 
            className="border-[#052557] text-[#052557] hover:bg-[#052557] hover:text-white px-6 lg:px-8 xl:px-9 py-3 lg:py-4 h-auto lg:h-[54px] text-base lg:text-lg whitespace-nowrap"
          >
            Learn More
          </Button>
        </div>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
      <Card className="p-5 sm:p-6 text-center border-0 shadow-none bg-white">
        <CardContent className="p-0 space-y-3 sm:space-y-4">
          ...
          <h3 className="text-lg sm:text-xl font-semibold text-zkteco-text-dark">Biometric Security</h3>
          <p className="text-base sm:text-lg lg:text-xl text-zkteco-text-gray leading-[150%]">
      ...
      <Card className="p-5 sm:p-6 text-center border-0 shadow-none bg-white">
        <CardContent className="p-0 space-y-3 sm:space-y-4">
          ...
          <h3 className="text-lg sm:text-xl font-semibold text-zkteco-text-dark">Mobile Ready</h3>
          <p className="text-base sm:text-lg lg:text-xl text-zkteco-text-gray leading-[150%]">
      ...
      <Card className="p-5 sm:p-6 text-center border-0 shadow-none bg-white sm:col-span-2 lg:col-span-1">
        <CardContent className="p-0 space-y-3 sm:space-y-4">
          ...
          <h3 className="text-lg sm:text-xl font-semibold text-zkteco-text-dark">Flexible Systems</h3>
          <p className="text-base sm:text-lg lg:text-xl text-zkteco-text-gray leading-[150%]">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-10 sm:mb-12">
      <Card className="bg-zkteco-card-blue border-0 p-5 sm:p-6 text-white">
        <CardContent className="p-0">
          ...
          <p className="text-sm sm:text-base text-white">
            Official certification and training for optimal system performance.
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="bg-zkteco-card-blue border-0 p-5 sm:p-6 text-white">
        <CardContent className="p-0">
          ...
          <p className="text-sm sm:text-base text-white">
            NYS Alarm Certified with full insurance coverage for peace of mind.
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="bg-zkteco-card-blue border-0 p-5 sm:p-6 text-white sm:col-span-2 lg:col-span-1">
        <CardContent className="p-0">
          ...
          <p className="text-sm sm:text-base text-white">
            Seamless integration with cameras, intercoms, and third-party systems.
          </p>
        </CardContent>
      </Card>
    </div>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 lg:gap-8">
      <Card className="bg-zkteco-section-gray border-0 p-4 sm:p-5 lg:p-6">
        <CardContent className="p-0">
          ...
          <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-zkteco-text-dark mb-3 sm:mb-4">Corporate Offices</h3>
      ...
      <Card className="bg-zkteco-section-gray border-0 p-4 sm:p-5 lg:p-6">
        <CardContent className="p-0">
          ...
          <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-zkteco-text-dark mb-3 sm:mb-4">Apartments & Condos</h3>
          <p className="text-zkteco-text-gray text-sm sm:text-base">
      ...
      <Card className="bg-zkteco-section-gray border-0 p-4 sm:p-5 lg:p-6">
        <CardContent className="p-0">
          ...
          <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-zkteco-text-dark mb-3 sm:mb-4">Gyms & Wellness</h3>
          <p className="text-zkteco-text-gray text-sm sm:text-base">
      ...
      <Card className="bg-zkteco-section-gray border-0 p-4 sm:p-5 lg:p-6">
        <CardContent className="p-0">
          ...
          <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-zkteco-text-dark mb-3 sm:mb-4">Schools & Campus</h3>
          <p className="text-zkteco-text-gray text-sm sm:text-base">
      ...
      <Card className="bg-zkteco-section-gray border-0 p-4 sm:p-5 lg:p-6 sm:col-span-2 lg:col-span-1">
        <CardContent className="p-0">
          ...
          <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-zkteco-text-dark mb-3 sm:mb-4">Industrial Sites</h3>
          <p className="text-zkteco-text-gray text-sm sm:text-base">
      ...
      <Card className="bg-white shadow-lg border-0 p-5 sm:p-6 lg:p-8">
        <CardContent className="p-0">
          <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
            ...
            <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-zkteco-text-dark">Elevator Control</h3>
          </div>
      ...
      <Card className="bg-white shadow-lg border-0 p-5 sm:p-6 lg:p-8">
        <CardContent className="p-0">
          <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
            ...
            <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-zkteco-text-dark">Surveillance Integration</h3>
          </div>
          <p className="text-sm sm:text-base text-zkteco-text-gray">
            Log access events with linked video snapshots for enhanced security
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="bg-white shadow-lg border-0 p-5 sm:p-6 lg:p-8">
        <CardContent className="p-0">
          <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
            ...
            <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-zkteco-text-dark">Intercom Systems</h3>
          </div>
          <p className="text-sm sm:text-base text-zkteco-text-gray">
            Allow visitor verification through integrated communication interfaces
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="bg-white shadow-lg border-0 p-5 sm:p-6 lg:p-8">
        <CardContent className="p-0">
          <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
            ...
            <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-zkteco-text-dark">Time & Attendance</h3>
          </div>
          <p className="text-sm sm:text-base text-zkteco-text-gray">
            Streamline payroll and employee tracking with integrated timekeeping
          </p>
        </CardContent>
      </Card>
    </div>
  ...
  <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 max-w-[1920px]">
    <div className="text-center max-w-full sm:max-w-2xl lg:max-w-[896px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center px-4">
        <Button className="bg-[#052557]  text-white px-6 sm:px-8 py-4 sm:py-5 h-auto sm:h-[62px] text-base sm:text-lg flex items-center justify-center gap-2 sm:gap-3">
          <Phone className="w-4 h-4 sm:w-[18px] sm:h-[18px]" />
          Call Now
        </Button>
        <Button 
          variant="outline" 
          className="border-zkteco-primary-blue text-zkteco-primary-blue hover:bg-zkteco-primary-blue hover:text-white px-6 sm:px-8 py-4 sm:py-5 h-auto sm:h-[62px] text-base sm:text-lg flex items-center justify-center gap-2 sm:gap-3"
        >
