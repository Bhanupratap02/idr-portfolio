...
export default function ViconVaxCard({
  icon,
  title,
  description,
}: ViconVaxCardProps) {
  return (
    <div className="group bg-white rounded-lg sm:rounded-xl md:rounded-2xl lg:rounded-xl xl:rounded-2xl 2xl:rounded-2xl 3xl:rounded-3xl shadow-sm border border-gray-100 hover:shadow-lg hover:border-gray-200 transition-all duration-300 hover:-translate-y-1 p-4 sm:p-5 md:p-6 lg:p-5 xl:p-6 2xl:p-8 3xl:p-10 h-full">
