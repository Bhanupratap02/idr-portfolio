  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center mb-16 sm:mb-20 lg:mb-32">
          <div className="order-2 lg:order-1">
            <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 lg:p-10 hover:shadow-2xl transition-shadow duration-300">
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8 mb-16 sm:mb-20 lg:mb-32">
          {/* Continuous Improvement Card */}
          <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 lg:p-10 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
        ...
        <div className="bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 rounded-3xl shadow-2xl p-8 sm:p-12 lg:p-16 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="relative mt-12">
              <div className="absolute -top-6 left-1/2 transform -translate-x-1/2">
                <svg className="w-12 h-12 text-blue-400 opacity-50" fill="currentColor" viewBox="0 0 32 32">
              ...
              <blockquote className="relative pt-8 px-4 sm:px-8">
                <p className="text-2xl sm:text-3xl lg:text-4xl font-light text-white italic leading-relaxed">
        ...
        <div className="mt-16 sm:mt-20 text-center">
          <button className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 sm:px-12 py-4 sm:py-5 rounded-full text-lg sm:text-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
