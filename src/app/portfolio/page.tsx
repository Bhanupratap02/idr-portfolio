...
import Access1 from "@/assets/portfolio/AccessControl1.jpg"
import Access2 from "@/assets/portfolio/AccessControl2.jpg"
import Access3 from "@/assets/portfolio/AccessControl3.jpg"
import Access4 from "@/assets/portfolio/AccessControl4.jpg"
import Audio1 from "@/assets/portfolio/AudioVisual1.jpg"
import Audio2 from "@/assets/portfolio/AudioVisual2.png"
import Audio3 from "@/assets/portfolio/AudioVisual3.png"
import Audio4 from "@/assets/portfolio/AudioVisual4.png"
import cabling1 from "@/assets/portfolio/StructuredCabling1.jpg"
import cabling2 from "@/assets/portfolio/StructuredCabling2.jpg"
import cabling3 from "@/assets/portfolio/StructuredCabling3.jpg"
import cabling4 from "@/assets/portfolio/StructuredCabling4.jpg"
import camera1 from "@/assets/portfolio/Surveillance1.jpg"
import camera2 from "@/assets/portfolio/Surveillance2.jpg"
import camera3 from "@/assets/portfolio/Surveillance3.jpg"
import camera4 from "@/assets/portfolio/Surveillance4.jpg"
import data1 from "@/assets/portfolio/DataCenter1.jpeg"
import data2 from "@/assets/portfolio/DataCenter2.jpg"
import data3 from "@/assets/portfolio/DataCenter3.jpeg"
import data4 from "@/assets/portfolio/DataCenter4.jpg"
import intercom1 from "@/assets/portfolio/Intercom1.jpg"
import intercom2 from "@/assets/portfolio/Intercom2.jpg"
import intercom3 from "@/assets/portfolio/Intercom3.jpg"
import intercom4 from "@/assets/portfolio/Intercom4.jpg"
import room1 from "@/assets/portfolio/ConferenceRoom1.png"
import room2 from "@/assets/portfolio/ConferenceRoom2.jpeg"
import room3 from "@/assets/portfolio/ConferenceRoom3.jpeg"
import room4 from "@/assets/portfolio/ConferenceRoom4.png"
import network1 from "@/assets/portfolio/NetworkIT1.jpg"
import network2 from "@/assets/portfolio/NetworkIT2.jpg"
import network3 from "@/assets/portfolio/NetworkIT3.jpg"
import network4 from "@/assets/portfolio/NetworkIT4.jpg"
...
const workSections = [
  {
    ...
    icon: (
      <svg className="w-6 h-6 sm:w-7 sm:h-7  xl:w-8 xl:h-8 2xl:w-10 2xl:h-10 text-blue-600" viewBox="0 0 32 32" fill="none">
  ...
  },
  {
    ...
    icon: (
      <svg className="w-8 h-6 sm:w-9 sm:h-7 xl:w-10 xl:h-8 2xl:w-11 2xl:h-9 3xl:w-12 3xl:h-10 text-blue-600" viewBox="0 0 40 32" fill="none">
    ...
    images: [Audio1, Audio2, Audio3,Audio4]
  },
  {
    id: "conference-room",
  ...
  },
  {
    ...
    icon: (
      <svg className="w-6 h-6 sm:w-7 sm:h-7 xl:w-8 xl:h-8 2xl:w-9 2xl:h-9 3xl:w-10 3xl:h-10 text-blue-600" viewBox="0 0 32 32" fill="none">
    ...
    images: [data1, data2, data3,data4]
  },
  {
    id: "networks-it",
    ...
    images: [network1, network2, network3,network4]
  },
  {
    id: "multifamily",
    ...
    icon: (
      <svg className="w-5 h-6 sm:w-6 sm:h-7 xl:w-6 xl:h-8 2xl:w-7 2xl:h-9 3xl:w-8 3xl:h-10 text-blue-600" viewBox="0 0 24 32" fill="none">
    ...
    images: [intercom1, intercom2, intercom3,intercom4]
  },
  // {
  //   id: "security-alarm",
  ...
  // },
  {
    ...
    icon: (
      <svg className="w-7 h-6 sm:w-8 sm:h-7 xl:w-9 xl:h-8 2xl:w-10 2xl:h-9 3xl:w-11 3xl:h-10 text-blue-600" viewBox="0 0 36 32" fill="none">
    ...
    images: [cabling1, cabling2, cabling3,cabling4]
  },
  {
    id: "surveillance",
